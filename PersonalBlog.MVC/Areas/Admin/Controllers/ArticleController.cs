...
namespace PersonalBlog.MVC.Areas.Admin.Controllers
{
    ...
    public class ArticleController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add(ArticlesAddDto articleAddDto, IFormFile fileImg)
        {
            if (ModelState.IsValid)
            {
                ...
                await _articleService.Add(articleAddDto, "Evren Uludağ");
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(ArticlesUpdateDto articleUpdateDto, IFormFile fileImg)
        {
            if (ModelState.IsValid)
            {
                if (fileImg != null)
                ...
                await _articleService.Update(articleUpdateDto, "Evren Uludağ");
                return RedirectToAction("Index");
            }
            var categories = await _categoryService.GetAllByNonDeleteAndActive();
            ViewBag.CategoryList = categories.Data.Categories;
